 ...
 public:
   ...
   public:
    ...
    virtual ::grpc::experimental::ServerBidiReactor< ::tensorflow::Event, ::tensorflow::EventReply>* SendEvents() {
      return new ::grpc::internal::UnimplementedBidiReactor<
        ::tensorflow::Event, ::tensorflow::EventReply>;}
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_SendTracebacks : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodCallback(1,
        new ::grpc::internal::CallbackUnaryHandler< ::tensorflow::CallTraceback, ::tensorflow::EventReply>(
          [this](::grpc::ServerContext* context,
                 const ::tensorflow::CallTraceback* request,
                 ::tensorflow::EventReply* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->SendTracebacks(context, request, response, controller);
                 }));
    }
    ...
    virtual void SendTracebacks(::grpc::ServerContext* context, const ::tensorflow::CallTraceback* request, ::tensorflow::EventReply* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_SendSourceFiles : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_SendSourceFiles() {
      ::grpc::Service::experimental().MarkMethodCallback(2,
        new ::grpc::internal::CallbackUnaryHandler< ::tensorflow::DebuggedSourceFiles, ::tensorflow::EventReply>(
          [this](::grpc::ServerContext* context,
                 const ::tensorflow::DebuggedSourceFiles* request,
                 ::tensorflow::EventReply* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->SendSourceFiles(context, request, response, controller);
                 }));
    }
    ...
    virtual void SendSourceFiles(::grpc::ServerContext* context, const ::tensorflow::DebuggedSourceFiles* request, ::tensorflow::EventReply* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  ...
  class ExperimentalWithRawCallbackMethod_SendTracebacks : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(1,
        new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->SendTracebacks(context, request, response, controller);
                 }));
    }
    ...
    virtual void SendTracebacks(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_SendSourceFiles : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(2,
        new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->SendSourceFiles(context, request, response, controller);
                 }));
    }
    ...
    virtual void SendSourceFiles(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
